...
function register_ai_child_starter_theme_sidebars()  {
    ...
    register_sidebar(array( 
       'name' => 'Hp Buffalo Stories',
       'id'=>'hp-buffalo-stories',
       'before_widget' => '',
	   'after_widget' => '',
	   'before_title' => '',
	   'after_title' => ''
...
function ai_starter_theme_enqueue_child_assets()  {
	...
	wp_enqueue_style('fonts-Monsteratt','https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600;1,700&display=swap');
