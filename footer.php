...
<footer class="footer">
	<div class="footer-logo">
		<img alt="Footer Logo" src="<?php echo get_stylesheet_directory_uri() ?>/images/footer-1logo.png" width="193"
			height="145" />
		<img  class="logo2"alt="Footer Logo" src="<?php echo get_stylesheet_directory_uri() ?>/images/footer-2logo.png" width="220"
			height="100" />
	</div>
	<div class="footer-mid">
		...
		<div class="footer-group">
			...
			<p class="copyright">Copyright ©
				<?php echo do_shortcode('[currentYear]')?> <span class="sitename">The Monroe Team . </span> All rights
				reserved. | <a class="terms" href="<?php echo do_shortcode('[blogurl]')?>/terms">Terms of Use</a> | <a
	...
	<p class="footer-outro">The Monroe Team is committed to providing an accessible website. If you have difficulty
		...
		contact us at
		<?php echo do_shortcode('[ai_phone href="+1.281.335.0335"] 281.335.0335[/ai_phone]')?> to specify the nature of
